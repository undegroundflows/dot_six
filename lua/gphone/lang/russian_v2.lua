...
local l = gPhone.createLanguage( "Russian_v2" )

-- General
l.title = "Garry phone"
l.slide_unlock = "Разблокируйте"
l.update_check_fail = "Не удалось проверить обновления, пожалуйста, обратитесь в техподдержку gPhone"
...
-- Homescreen
l.battery_dead = "Уровень заряда батареи слишком мал."
l.battery_okay = "Заряжено!"
l.service_provider = "Garry"
l.folder_fallback = "Папка"
l.invalid_folder_name = "Недействительный"

-- Tutorial
l.tut_welcome = "Добро пожаловать в gPhone! Это краткое руководство познакомит вас с телефоном."
...
l.app_deny_gm = "Это приложение не имеет проблемы совместимости с модом и не может использоваться!"
l.app_deny_group = "Ваших прав недостаточно, чтобы использовать это приложение!"
...
l.yes = "Да"
l.okay = "Ок"
l.response_timeout = "%s не ответил на ваш запрос."
...
l.phone_deny = "%s сбросил ваш звонок"
