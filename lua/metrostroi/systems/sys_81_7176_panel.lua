--------------------------------------------------------------------------------
-- Панель управления 81-717.6
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_7176_Panel")
...
function TRAIN_SYSTEM:Initialize()
	...
	self.Train:LoadSystem("VAD","Relay","Switch", {button = true})
	self.Train:LoadSystem("VUS","Relay","Switch", {button = true})
	...
	self.Train:LoadSystem("ALS","Relay","Switch", {av = true})
	...
	self.Train:LoadSystem("R_Program1","Relay","Switch", {button = true, programm = true})
	self.Train:LoadSystem("R_Program2","Relay","Switch", {button = true, programm = true})
	...
	self.Train:LoadSystem("L_4","Relay","Switch",{button = true})
	self.Train:LoadSystem("L_5","Relay","VA21-29")
	self.Train:LoadSystem("DoorSelect","Relay","Switch", { button = true, normally_closed = false })
